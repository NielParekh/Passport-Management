...
aadhar_card = input("Enter pan card ")
...
if exists == 1:
    try:
        with connect(
            ...
            add_records=f"INSERT INTO users(user_id,choice,username,password,email_id,aadhar_card,address,status_admin,status_police) VALUES('{uuid_user}','{choice}','{username}','{password}','{email_id}','{aadhar_card}','{address}','{status_admin}','{status_police}')"
            with connection.cursor() as cursor:
